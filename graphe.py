...
arsene= open("arsene_lupin_extrait.txt","r",encoding="utf-8").read()
...
def timeur_cryptage(phrase_claire,clee_SDES1, clee_SDES12,clee_AES):
    t1 = time.perf_counter()
    SDES= double_cryptage_SDES(phrase_claire,clee_SDES1, clee_SDES12)
    t2 = time.perf_counter()
    AES= cryptage_AES(phrase_claire,clee_AES)
    t3 = time.perf_counter()
    return (t2-t1,t3-t2)

def timeur_decryptage(phrase_crypte_SDES,phrase_crypte_AES,clee_SDES1,clee_SDES2,clee_AES):
    t1 = time.perf_counter()
    SDES= double_decryptage_SDES(phrase_crypte_SDES,clee_SDES1,clee_SDES2)
    t2 = time.perf_counter()
    AES= decrypt_AES(phrase_crypte_AES,clee_AES)
    t3 = time.perf_counter()
    return (t2-t1,t3-t2)
...
d1= timeur_decryptage(double_cryptage_SDES(arsene[:1],10,5),cryptage_AES(arsene[:1],"AES"),10,5,"AES")
print(d1)
d2= timeur_decryptage(double_cryptage_SDES(arsene[:10],10,5),cryptage_AES(arsene[:10],"AES"),10,5,"AES")
print(d2)
d3= timeur_decryptage(double_cryptage_SDES(arsene[:100],10,5),cryptage_AES(arsene[:100],"AES"),10,5,"AES")
print(d3)
d4= timeur_decryptage(double_cryptage_SDES(arsene[:200],10,5),cryptage_AES(arsene[:200],"AES"),10,5,"AES")
print(d4)
d5= timeur_decryptage(double_cryptage_SDES(arsene[:500],10,5),cryptage_AES(arsene[:500],"AES"),10,5,"AES")
print(d5)
d6= timeur_decryptage(double_cryptage_SDES(arsene[:800],10,5),cryptage_AES(arsene[:800],"AES"),10,5,"AES")
print(d6)
d7= timeur_decryptage(double_cryptage_SDES(arsene[:1000],10,5),cryptage_AES(arsene[:1000],"AES"),10,5,"AES")
print(d7)
d8= timeur_decryptage(double_cryptage_SDES(arsene[:1500],10,5),cryptage_AES(arsene[:1500],"AES"),10,5,"AES")
print(d8)
size="1","10","100","200","500","800","1000","1500"
